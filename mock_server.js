// a mocked server using miragejs
...
export function makeServer() {
    return createServer({
        ...
        seeds(server) {
            ...
            server.create("van", { id: "2", name: "Beach Adventure", price: 80, description: "Beach Adventure is a van inspired by surfers and travelers. It was created to be a portable home away from home, but with some cool features in it you won't find in an ordinary camper.", imageUrl: "https://assets.scrimba.com/advanced-react/react-router/beach-bum.png", type: "rugged", hostId: "123" })
            ...
            server.create("user", { id: "123", email: "lem@on.com", password: "123", name: "Lemon" })
        },
        ...
        routes() {
            ...
            this.post("/login", (schema, request) => {
                ...
                return {
                    user: foundUser,
                    token: "Enjoy your ice cream, here's your tokens."
                }
            })
        }
    })
